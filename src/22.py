...
def solve_1(instructions):
    ...
    for v in reactor.values():
        if v == 'on':
            result += 1
    return result, (max_x-min_x)*(max_y-min_y)*(max_z-min_z)
...
def solve_2(instructions):
    ...
    for status, ranges in instructions:
        ...
        rangey = ranges[1]
        rangez = ranges[2]
        x1, y1, z1 = rangex[0], rangey[0], rangez[0]
        x2, y2, z2 = rangex[1], rangey[1], rangez[1]
...
def intersects(r1, r2):
    ...
    return segments_intersect(r1x1, r1x2, r2x1, r2x2) and segments_intersect(r1y1, r1y2, r2y1, r2y2) and segments_intersect(r1z1, r1z2, r2z1, r2z2)
...
def segments_intersect(ax, bx, cx, dx):
    return bx >= cx and dx >= ax
